...
El objetivo de esta topología no es reproducir una infraestructura empresarial completa, sino **proporcionar un entorno controlado y representativo** que permita generar eventos adecuados para su análisis por parte del Laboratorio SIEM.
...
- Generación de eventos reales o simulados de forma reproducible.
...
- En la fase actual del proyecto, parte de los eventos utilizados para las pruebas se generan de forma controlada mediante peticiones manuales a la API de ingesta.
    
- Los eventos se envían al Laboratorio SIEM mediante peticiones a la API.
...
La topología del laboratorio proporciona el **contexto práctico necesario** para validar el funcionamiento del Laboratorio SIEM, sirviendo como fuente de eventos representativos y controlados sin ampliar el alcance del proyecto.
