...
#dam #english #apuntes
## 🗂️ Product Management: Identify problems

---
## 🔹 1.1 Section 1 – Grammar: The Passive Voice
...
## 🔹 1.2 Section 2 – Grammar: Relative Pronouns
...
👉 _It’s not my team whose data is being questioned._
...
## 🔹 1.3 Section 3 – Listening: UX Experience
...
## 🔹 1.4 Section 4 – Grammar: _As if_ & _As though_
...
### 1.4.3 Exercise 1 – Complete the sentences

1. It .......... we couldn't get access to behind-the-firewall data.  
    ✅ **looked as though**
    
2. The customers commented on the prototype as if they .......... that problem in their company.  
    ✅ **didn't have**
    
3. Looking at the query results, .......... they counted customers who use internal active directories.  
    ✅ **it appears as though**
    
4. They are acting .......... normal to have so many detractors.  
    ✅ **as if it were**
    
5. They were talking as though .......... the option of secondments from other teams.  
    ✅ **we didn't have**
    

---

### 1.4.4 Exercise 2 – Hypothetical or real?
...
## 🔹 1.5 Section 5 – Reading: Supplier Evaluation Modules

### 📖 Vocabulario 1

1. **Secondment** → A temporary transfer of an employee to another project.
    
2. **Onboarding** → The process of training a new employee.
    
3. **Go out of business** → When a company stops all operations.
    
4. **Mitigate risks** → To reduce the chances of something bad happening.
    
5. **Worst-case scenario** → The most unpleasant thing that can happen.
    
6. **Cooperate** → To work together to achieve an objective.
...
- training a new employee → ✅ **onboarding**
    
- the most unpleasant thing → ✅ **worst-case scenario**
    
- reduce the chances of something bad happening → ✅ **mitigate risks**
    
- to stop all operations → ✅ **go out of business**
    
- temporary transfer of an employee → ✅ **secondment**
...
1. Significant delay due to changing requests → ✅ **Scope creep**
    
2. Visit to supplier’s factory → ✅ **Supplier evaluation**
    
3. Break down product into increments → ✅ **Incremental value delivery**
    

---

### 1.5.5 Exercise – Reading comprehension

1. A supplier evaluation module is used to:  
    ✅ **prevent the customer from working with risky suppliers.**
    
2. They need to keep to the supplier evaluation deadline because:  
    ✅ **the customer urgently needs reliable suppliers.**
    
3. The team cannot deliver the module on time because:  
    ✅ **the development team capacity has decreased over the last months.**
    
4. The development team decide to:  
    ✅ **check their available resources.**
    
5. Incremental value delivery involves:  
